...
class TransferPresenterUnitTest {
    ...
    @Mock
    private lateinit var mockView: TransferContract.View

    @Before
    fun setUp() {
        transferPresenter = TransferPresenter(mockView)
    }
    ...
    fun when_transferWithSameAccount_then_returnSameFromAndToAccountError() {
        ...
        then(mockView).should().showTransferError(R.string.error_from_and_to_account_cannot_be_the_same)
    }
    ...
    fun when_transferWithInvalidAmount_then_returnInvalidAmountError() {
        ...
        then(mockView).should().showTransferError(R.string.error_invalid_amount)
    }
